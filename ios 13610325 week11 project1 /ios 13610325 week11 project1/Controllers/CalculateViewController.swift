...
class CalculateViewController: UIViewController {
    ...
    //Global Variable คือ ตัวแปรงตรงกลางที่ใช้ร่วมกันได้ใน Class ฟังก์ชั่นอื่นสามารถเรียกฝช้ได้
    //var bmiValueCal = "0"
    ...
    @IBAction func calculatePressed(_ sender: Any) {
        ...
        //เรียกใช้ struct #2 เรียกฟังก์ชั่น struct โดยการส่งค่าที่ต้องการไป
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        // ชื่อ obeject.ชื่อตัวแปร = ค่าที่ต้องการ set ให้
            ...
            //เรียกใช้ struct #3 เรียกใช้ fuction getBMIValue()
            //ส่งกลับมาเป็น String ซึ่งเป็นชนิดเดียวกับที่ .bmiValue ต้องการ
            //ตัวเดียวกันด้วยชื่อ calculatorBrain
        ...
        if segue.identifier == "goToCredit" {
            ...
            CreditVC.fullname = "Jirakit Chobthumkit"
        }
